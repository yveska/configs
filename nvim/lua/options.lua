...
vim.opt.inccommand = "split" -- incremental search :%s/_ splits
...
vim.opt.cmdheight = 1 -- one line commmand line
...
vim.opt.guicursor = -- cursor blink -> do "" instead to match terminal
